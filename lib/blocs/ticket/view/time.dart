                    ...
                    rows: List<DataRow>.generate(
                        ...
                        (int index) => DataRow(
                              ...
                              cells: <DataCell>[
                                ...
                                DataCell(Text(widget.pickup[index].id)),
                                DataCell(Text(widget.pickup[index].tourid)),
                                DataCell(Text(
                                    "${widget.pickup[index].time.length} Option")),
                                DataCell(Text(
